...
using namespace std;
/**
 Hacer un programa para ingresar una lista de 10 números enteros, luego informar el máximo y
...
int main(){
      ...
      for(int i=1;i<=10;i++){
        ...
        if(i == 1 || numero > maximo){
           ...
           cout << "la posicion es: " << posicionM << endl;
    return 0;
}
