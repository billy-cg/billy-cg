...
using namespace std;
/**
  Se defi ne como divisores propios de un número entero
  ...
  Se defi ne a un número como perfecto cuando la suma de todos sus
  ...
  cartel aclaratorio si el mismo es un número perfecto o no es número perfecto
